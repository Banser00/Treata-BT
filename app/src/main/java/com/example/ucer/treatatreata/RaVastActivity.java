...
public class RaVastActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vastsss_id : i = new Intent(this, RaceSongActivity.class); startActivity(i) ; break;
