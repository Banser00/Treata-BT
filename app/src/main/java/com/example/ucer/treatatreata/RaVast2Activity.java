...
public class RaVast2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song2 = MediaPlayer.create(RaVast2Activity.this,R.raw.alla);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vast2sss_id : i = new Intent(this, RaceSongActivity.class); startActivity(i) ; break;
