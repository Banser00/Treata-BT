...
public class CoVast3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song3 = MediaPlayer.create(CoVast3Activity.this,R.raw.bee);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vast3sss_id : i = new Intent(this, CoSongActivity.class); startActivity(i) ; break;
