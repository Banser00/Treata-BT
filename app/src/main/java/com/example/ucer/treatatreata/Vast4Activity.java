...
public class Vast4Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song4 = MediaPlayer.create(Vast4Activity.this,R.raw.bridge);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vast4sss_id : i = new Intent(this, PerSongActivity.class); startActivity(i) ; break;
