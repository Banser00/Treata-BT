...
public class CoVastActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song = MediaPlayer.create(CoVastActivity.this,R.raw.littlestar);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vastsss_id : i = new Intent(this, CoSongActivity.class); startActivity(i) ; break;
