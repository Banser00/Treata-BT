...
public class RaVast3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song3 = MediaPlayer.create(RaVast3Activity.this,R.raw.bee);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vast3sss_id : i = new Intent(this, RaceSongActivity.class); startActivity(i) ; break;
