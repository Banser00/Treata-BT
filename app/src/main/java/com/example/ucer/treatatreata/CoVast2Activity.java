...
public class CoVast2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song2 = MediaPlayer.create(CoVast2Activity.this,R.raw.alla);
    ...
    public void onClick(View view) {
        ...
        switch ( view.getId()) {
            case R.id.vast2sss_id : i = new Intent(this, CoSongActivity.class); startActivity(i) ; break;
